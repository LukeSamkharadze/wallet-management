...
def test_db_add_user() -> None:
    ...
    user = DbAddUserIn(name=name, api_key=api_key, create_date_utc=create_date_utc)
...
def test_db_update_wallet_balance() -> None:
    ...
    update_wallet_balance_in = DbUpdateWalletBalanceIn(
        public_key=public_key, amount=updated_btc_amount
    )
...
def test_db_update_commission_stats() -> None:
